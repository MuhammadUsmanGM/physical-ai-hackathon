...
const config = {
  ...
  url: 'https://muhammadusmanGM.github.io',
  ...
  organizationName: 'MuhammadUsmanGM', // Usually your GitHub org/user name.
  projectName: 'physical-ai-hackathon', // Usually your repo name.
